...
export function gradAdminRequest(
  ...
  // (The self-check file is no longer attached — DGS 2026-09-15.)
  const attached = 'Attached: my original transcripts as PDFs (Bachelor’s / Master’s / Ph.D., whichever apply).';
  const closing =
