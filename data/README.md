...
| `phd_senior_grad_credits_max` | 6 | §3.5 | how much of §3.5's junior/senior-year 6xxxx coursework may transfer into the **Ph.D.** — "one or two 3-credit CSE courses", so 6. These are courses taken BEFORE the bachelor's degree, which §5.2 otherwise bars; the DGS allows them for Notre Dame's own 4+1 only (2026-09-10). They still need the DGS's recommendation like any transfer, they count inside §5.2's overall cap, and where a student has more than the allowance the courses that satisfy more of the qualifier (a §4.4.1 core area, a §4.4.2 group) fill it first |
